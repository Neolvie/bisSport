...
using bisSport.WebClient.Areas.Football.Models;
using bisSport.WebClient.Controllers;

namespace bisSport.WebClient.Areas.Football.Controllers
{
    ...
    public ActionResult MatchList(int roundId)
    {
      ...
      switch (round.Type)
      {
        case RoundType.AllPlayAll:
          return View("~/Areas/Football/Views/Round/AllPlayAllRound.cshtml", model);
        case RoundType.Playoff:
          return View("~/Areas/Football/Views/Round/PlayOffRound.cshtml", model);
        default:
