...
intellisense.annotate(jQuery, {
  ...
  'boxModel': function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the IParticipant's browser, is being rendered using the W3C CSS Box Model.</summary>
  ...
  'browser.version': function() {
    /// <summary>The version number of the rendering engine for the IParticipant's browser.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
